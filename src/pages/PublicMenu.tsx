...
const ARExperience = React.lazy(() => import('../components/ar/ARExperience'));
  ...
  return (
    ...
    >
      ...
      {show3DFull && selectedItem?.model3D && (
        <React.Suspense fallback={<div className="fixed inset-0 z-50 bg-black flex items-center justify-center text-white">Loading AR...</div>}>
          <ARExperience
            modelUrl={selectedItem.model3D}
            dishName={isRtl ? selectedItem.nameAr : selectedItem.nameEn}
